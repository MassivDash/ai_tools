...
pub async fn get_chromadb_health(chroma_address: web::Data<String>) -> ActixResult<HttpResponse> {
    println!("🔍 Checking ChromaDB health at: {}", chroma_address.as_str());
        ...
        Ok(client) => {
            match client.health_check().await {
                Ok(connected) => {
                    ...
                    Ok(HttpResponse::Ok().json(ChromaDBResponse {
                        ...
                        data: Some(ChromaDBHealthResponse {
                            ...
                            chromadb: crate::api::chromadb::types::ChromaDBStatus {
                                connected,
                            },
                        }),
                        error: None,
                ...
                Err(e) => {
                    ...
                    Ok(HttpResponse::ServiceUnavailable().json(ChromaDBResponse::<ChromaDBHealthResponse> {
                        success: false,
                        data: Some(ChromaDBHealthResponse {
