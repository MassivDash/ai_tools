...
🦀 A comprehensive web application for managing and testing LLM workflows with llama.cpp, vector databases, and AI agents.
</h2> </div> </div>
...
ai_tools
├─ src
│  ├─ backend          # Actix backend (Rust)
│  │  ├─ src
│  │  │  ├─ api
│  │  │  │  ├─ agent          # AI agent implementation
│  │  │  │  │  ├─ tools       # Tool system (ChromaDB, etc.)
│  │  │  │  ├─ llama_server   # Llama.cpp server management
...
│  │  │  │  ├─ llamaServer    # Llama.cpp server UI
│  │  │  │  ├─ chromadb       # Vector DB management UI
│  │  │  │  └─ tools          # Conversion tools UI
│  │  │  ├─ pages
│  │  │  │  ├─ agent.astro    # Agent page
│  │  │  │  ├─ database.astro # Vector DB page
